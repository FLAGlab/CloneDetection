...
public class Dart2Parser extends Parser {
	...
	public static final int
		RULE_dart = 0, RULE_variableDeclaration = 1, RULE_declaredIdentifier = 2, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"dart", "variableDeclaration", "declaredIdentifier", "finalConstVarOrType", 
	...
	public static class DartContext extends ParserRuleContext {
		...
		public DartContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_dart; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof Dart2Listener ) ((Dart2Listener)listener).enterDart(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof Dart2Listener ) ((Dart2Listener)listener).exitDart(this);
		}
	}

	public final DartContext dart() throws RecognitionException {
		DartContext _localctx = new DartContext(_ctx, getState());
		enterRule(_localctx, 0, RULE_dart);
		try {
			setState(348);
